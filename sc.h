...
/* Edited by Qoo */
SC_VDECL stringlist sourcefiles;
SC_VDECL stringlist doincludefiles;

SC_VDECL stringpair substpair;
SC_VDECL stringpair* substindex['z' - PUBLIC_CHAR + 1];

SC_VDECL stringlist* insert_doincludefile(char* path);
